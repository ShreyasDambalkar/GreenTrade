...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 p-8 flex flex-col items-center">
      <h1 className="text-3xl font-bold text-green-800 mb-4">GreenTrade Dashboard</h1>
      <ConnectButton client={client} appMetadata={{ name: "GreenTrade", url: "https://greentrade.com" }} />
