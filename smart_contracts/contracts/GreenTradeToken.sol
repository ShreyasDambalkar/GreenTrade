...
/**
 * @title GreenTradeToken (GTT)
 * @dev ERC20 implementation for fungible carbon credits
 * 1 GTT = 1 ton CO₂ offset
 * This token is designed for DeFi integration and DEX trading
 */
contract GreenTradeToken is ERC20, ERC20Burnable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("GreenTrade Token", "GTT") Ownable(msg.sender) {
