          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-gradient-to-br from-emerald-500/20 to-emerald-500/20 border border-emerald-500/30 rounded-xl p-6">
                <h3 className="text-sm font-medium text-emerald-300 mb-1">Yearly Consumption</h3>
                <p className="text-3xl font-bold text-emerald-400">{formatLiters(result.yearly_liters)}</p>
                <p className="text-xs text-emerald-300">liters per year</p>
              </div>
