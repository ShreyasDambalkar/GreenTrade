...
const FAQ_DATA: FAQ[] = [
  {
    ...
    question: 'What is GreenTrade?',
    answer: 'GreenTrade is a comprehensive platform for carbon credit trading, sustainability tracking, and environmental impact management. We provide AI-powered tools to help individuals and businesses calculate, track, and offset their carbon footprint while participating in the carbon credit marketplace.'
  },
  {
    id: '2',
    category: 'Getting Started',
    question: 'How do I get started with GreenTrade?',
  ...
  },
  {
    id: '3',
    category: 'AI Tools',
    question: 'What AI tools does GreenTrade offer?',
    answer: 'GreenTrade offers several AI-powered tools: AI Carbon Calculator for emission analysis, AI Plastic Footprint calculator for plastic waste tracking, Sustainable Event Planner for eco-friendly event management, and a coming-soon Sustainability Chat for personalized advice.'
  },
  {
    id: '4',
    category: 'AI Tools',
  ...
  },
  {
    id: '5',
    category: 'Trading',
    question: 'How does carbon credit trading work on GreenTrade?',
    answer: 'GreenTrade provides a secure marketplace for buying and selling verified carbon credits. Our platform connects you with certified carbon offset projects, provides real-time pricing, and handles all transaction security through blockchain technology.'
  },
  {
    id: '6',
    category: 'Trading',
  ...
  },
  {
    ...
    answer: 'Yes! GreenTrade integrates with major crypto platforms to track carbon-related cryptocurrency investments, green tokens, and environmental blockchain projects alongside traditional carbon credits.'
  },
  {
    id: '9',
    category: 'Technology',
    question: 'What blockchain technology does GreenTrade use?',
    answer: 'GreenTrade is built on Ethereum and uses smart contracts for secure, transparent carbon credit transactions. We also integrate with other EVM-compatible networks and use IPFS for decentralized data storage.'
  },
  {
    id: '10',
    category: 'Technology',
    question: 'Is my data secure on GreenTrade?',
  ...
  },
  {
    ...
    question: 'How does GreenTrade help with sustainability goals?',
    answer: 'GreenTrade provides comprehensive sustainability management through carbon footprint tracking, offset purchasing, sustainable alternative recommendations, and detailed impact analytics to help you achieve net-zero goals.'
  },
  {
    id: '12',
    category: 'Sustainability',
    question: 'What sustainable alternatives does GreenTrade recommend?',
...
export default function Page() {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      type: 'bot',
      message: 'Hi! I\'m your GreenTrade assistant. I can help answer questions about our platform, AI tools, carbon trading, and sustainability features. What would you like to know?',
      timestamp: new Date()
    }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch('/api/greentrade-chat', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          message: inputMessage.trim(),
          context: 'GreenTrade FAQ Support'
        }),
      });
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
            Find answers to common questions about GreenTrade platform, AI tools, carbon trading, and sustainability features.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold">GreenTrade AI Assistant</h3>
                <p className="text-sm opacity-90">Ask me anything about GreenTrade</p>
              </div>
            </div>
              ...
              <div className="border-t border-zinc-200 dark:border-zinc-800 p-4">
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="Ask me about GreenTrade features, carbon trading, AI tools..."
