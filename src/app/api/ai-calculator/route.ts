...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!genAI) {
      // No API key available â€” return a helpful fallback sample calculation
      return NextResponse.json({
        success: true,
        rateLimited: true,
        data: {
          ...
          region: "Global",
          analysisNotes: "Fallback demo calculation â€” GEMINI_API_KEY not configured in environment.",
          totalEmissions: 150,
          scope1: 30,
          scope2: 50,
          scope3: 70,
