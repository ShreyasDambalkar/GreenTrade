...
// Don't throw at module load time if the API key is missing â€” that causes build-time failures
...
Provide practical, actionable recommendations that are specific to the event type and size. Include realistic cost estimates and carbon impact calculations. Focus on measurable outcomes and implementation feasibility.`;
    ...
    try {
      ...
      if (!genAI) {
        // No API key / client available â€” skip AI call and use fallback analysis directly
...
<body>
    <div class="header">
        <h1>ðŸŒ± Sustainable Event Planning Report</h1>
        <p><strong>${eventType}</strong> â€¢ ${attendees} attendees â€¢ ${duration} days</p>
        <p>Generated on ${new Date().toLocaleDateString()}</p>
    </div>

    <div class="section">
        <h2>ðŸ“Š Event Impact Analysis</h2>
    ...
    <div class="section">
        <h2>ðŸ’¡ Sustainability Recommendations</h2>
    ...
    <div class="footer">
        <p>ðŸŒ Generated by GreenTrade AI Event Planner</p>
