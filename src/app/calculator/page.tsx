      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <section className="lg:col-span-2 rounded-xl border border-zinc-800 bg-black/40 backdrop-blur p-4">
          ...
          <p className="mt-4 text-xs text-zinc-400">
            Estimates use public emission factors and are for guidance only. 1 credit = 1 tCOâ‚‚e.
          </p>
        </section>
        ...
        <aside className="rounded-xl border border-zinc-800 bg-black/40 backdrop-blur p-4 space-y-4">
          <div>
            ...
            <div className="text-3xl font-bold tracking-tight">{formatTons(totals.annualTons)} <span className="text-base font-medium text-zinc-400">tCOâ‚‚e</span></div>
          </div>
          ...
          <div className="rounded-lg border border-zinc-800 p-3">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-zinc-300">12â€‘month forecast</span>
