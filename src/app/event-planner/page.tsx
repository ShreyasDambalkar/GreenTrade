  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-zinc-800 text-zinc-100">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-green-400 via-emerald-500 to-emerald-400 bg-clip-text text-transparent mb-4">
                    ...
                    {aiAnalysis.sustainabilityRecommendations.slice(0, 3).map((rec, index) => (
                      <div key={index} className="bg-zinc-800/50 p-3 rounded-lg">
                        <div className="flex items-start gap-2">
                          <div className={`w-2 h-2 rounded-full mt-2 ${rec.priority === 'high' ? 'bg-red-400' :
              ...
              <div className="space-y-4">
                {items.map((item) => (
                  <motion.div
                    ...
                    className={`p-4 border rounded-xl transition-all duration-200 cursor-pointer ${item.completed
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mt-1 ${item.completed
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className={`px-2 py-1 text-xs rounded-full ${item.difficulty === 'easy' ? 'bg-green-900/50 text-green-300' :
                        ...
                        <div className="flex items-center gap-4 mt-3 text-xs">
                          ...
                          <div className={`flex items-center gap-1 ${item.costDiff >= 0 ? 'text-red-400' : 'text-green-400'
                            }`}>
