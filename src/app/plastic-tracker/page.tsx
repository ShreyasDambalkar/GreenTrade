...
export default function PlasticFootprintPage() {
  ...
  const environmentalImpact = useMemo(() => {
    ...
    return {
      ...
      landfillSpace: metrics.weight * 0.001 // mÂ³ of landfill space
    };
  }, [metrics.weight]);
    ...
    <div className="min-h-screen bg-rose-50 dark:bg-zinc-950">
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            â™»ï¸ Plastic Footprint Analysis
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 dark:from-blue-400 dark:via-cyan-400 dark:to-emerald-400 bg-clip-text text-transparent mb-6"
          >
            Visualize Your
            <br />
            Plastic Impact
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => {
                    const report = `ðŸ” PLASTIC FOOTPRINT REPORT
Timeframe: ${getTimeframeLabel()}
Total Weight: ${getWeightDisplay()}
Items Used: ${metrics.count.toLocaleString()}
COâ‚‚ Impact: ${environmentalImpact.carbonFootprint.toFixed(2)} kg
...
Generated by GreenTrade Plastic Tracker - ${new Date().toLocaleDateString()}`;
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-zinc-600 dark:text-zinc-400">
                        {item.weight}g â€¢ Decomposes in {item.decompositionTime}
                      </div>
                    </div>
                  </div>
