...
export default function WelcomeModal() {
  ...
  useEffect(() => {
    const seen = localStorage.getItem("greentrade_welcome_seen");
    if (!seen) setShowModal(true);
  }, []);

  const handleClose = () => {
    localStorage.setItem("greentrade_welcome_seen", "true");
    setShowModal(false);
  };
    ...
    <AnimatePresence>
      {showModal && (
        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold mb-4">Welcome to GreenTrade 🌍</h2>
