...
const slides: Slide[] = [
  ...
  },
  {
    ...
    bgGradient: "from-emerald-900/20 via-green-900/20 to-emerald-900/20",
    ambientColors: {
  ...
  },
  {
    ...
    bgGradient: "from-blue-900/20 via-cyan-900/20 to-emerald-900/20",
    ambientColors: {
    ...
    <section className="relative z-10 mx-auto max-w-7xl px-4 py-12 md:py-16">
      ...
      <div className="mt-6 mx-auto max-w-md">
        <div className="bg-zinc-800 rounded-full h-1 overflow-hidden">
          <div
            className={`bg-gradient-to-r from-indigo-500 to-purple-500 h-full transition-all duration-100 ease-linear ${isPlaying ? 'animate-progress' : 'w-0'
              }`}
          />
        </div>
      </div>
